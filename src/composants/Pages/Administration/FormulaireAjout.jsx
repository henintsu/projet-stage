...
const handleNationaliteChange = (event) => {
  ...
  const getForm = () => {
    axios.get('http://localhost:8081/poste')
        .then(res => setForm(res.data))
        .catch(err => console.log(err));
}
    ...
    <Box sx={{ display: 'flex' ,backgroundColor : '#f5f5f5',width : '100%' , height : '100vh' }}>
      ...
      <Box component="main" sx={{ flexGrow: 1 }} className='px-3' >
          ...
          <div className="card-body  col-12">
            <h4 className='card-header color-text'>Nouvelle enregistrement</h4>
            <br />
                    ...
                    <Container maxWidth="lg">
                        <Grid container spacing={3} c>
                                ...
                                <CardContent>
                                    ...
                                    <Grid container spacing={2} className='px-2'>
                                        ...
                                        <Grid item xs={12} sm={6}>
                                          ...
                                          <Grid item xs={12} sm={6} >
                                            <div className="form-floating mt-2">                                  
                                              <select id='code' className="form-select"  value={selectedNationaliteCode} name='codenationalitecli' onChange={handleChange} disabledls
                                              >
                                                <option selected></option>
                                                {
                                                  nationalites.map((nationalite, i) => (
                                        ...
                                        <Grid item xs={10} sm={4}>
                                          <div className="form-floating mt-2">
                                            <input 
                                              ...
                                              onChange={handleChange}
                                            />
                                            <label htmlFor="codedistrict">District</label>
                                          </div>
                                        </Grid>
                            ...
                            <Grid item xs={12} md={6} className="px-2">
                              <Card className="Card">
                                <CardContent>
                                  <h5 className="card-title">Autres Informations nécessaires</h5>
                                  <br />
                                  <Grid container spacing={2} className="px-2">
