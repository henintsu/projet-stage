				...
				<ul className="sidebar-nav">
					...
					<li className="sidebar-item">
						<Link className="sidebar-link" to="/DashCommune">
                            <i className="bi bi-geo-alt  align-middle" data-feather="grid"></i> <span className="align-middle">Commune</span>
                        </Link>
					</li>

					<li className="sidebar-item">
						<Link className="sidebar-link" to="/DashNationalite">
                            <i className="bi bi-pci-card align-middle" data-feather="align-left"></i> <span className="align-middle">Nationalite</span>
                        </Link>
					</li>
